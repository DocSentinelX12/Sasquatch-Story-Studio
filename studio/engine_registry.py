...
class EngineVerificationRecord:
    ...
    def __post_init__(self) -> None:
        required = (self.engine_id, self.engine_version, self.executable, self.version_observation, self.checkpoint_path, self.checkpoint_sha256, self.license_source, self.license_evidence, self.runtime_output_sha256)
...
class SQLiteEngineVerificationStore:
    ...
    def load(self, engine_id: str) -> EngineVerificationRecord | None:
        ...
        return None if row is None else EngineVerificationRecord(**json.loads(row[0]))
