...
ENGINE_CATALOG: tuple[EngineSpec, ...] = (
    ...
    EngineSpec("hunyuanvideo-1.5", "1.5", "https://github.com/Tencent-Hunyuan/HunyuanVideo-1.5", "Tencent Hunyuan Community License Agreement", ("video_generation", "image_generation"), ("python", "generate.py"), "very_high", True, "Worldwide territory excluding the European Union, United Kingdom, and South Korea"),
