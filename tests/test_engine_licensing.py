...
from studio.engine_registry import catalog_license_record
from studio.licensing import CommercialStatus


def test_catalog_engine_license_records_are_explicit_without_claiming_verification():
    record = catalog_license_record("wan2.2")
...
def test_ltx_checkpoint_requires_commercial_review():
    record = catalog_license_record("ltx-video")
